...
import { default_ship, draw_hull, draw_lasers, draw_ship, move_lasers, move_ship, shoot_laser } from "./ship.js"
...
// game_score, new_asteroid, high_score, set_high_score, asteroids_list
...
setInterval(() => {
	...
	move_ship(canvas, context, ship)
	draw_ship(ship, context, game_lives, canvas, game_text, asteroids_list, destroy_asteroid)
